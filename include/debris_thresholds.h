...
const float close_door_box_x1 = 0.0;
const float close_door_box_y1 = 1.0;
const float close_door_box_x2 = 1.0;
...
const float stay_opened_box_x1 = 0.0;
const float stay_opened_box_y1 = 0.0;
const float stay_opened_box_x2 = 1.0;
